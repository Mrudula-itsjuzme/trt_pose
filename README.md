...
3. Install the ONNX dependencies used by the `use_onnx=True` conversion path

    ```python
    sudo pip3 install onnx onnx-graphsurgeon
    ```
...
- [JetRacer](http://github.com/NVIDIA-AI-IOT/jetracer) - An educational AI racecar using NVIDIA Jetson
